...
- [French (Canada), latest available 4.14](https://github.com/GlobalDataverseCommunityConsortium/dataverse-language-packs/tree/dataverse-v4.14) maintained by [Bibliothèques Université de Montréal](https://bib.umontreal.ca/)
...
- [Spanish, 4.9.4](https://github.com/IQSS/dataverse-docker/blob/master/dataversedock/dataverse-property-files/es-ES/) maintained by [El Consorcio Madroño](http://consorciomadrono.es/en/)
